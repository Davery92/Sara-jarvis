...
export const CommandPalette: React.FC<CommandPaletteProps> = ({
  ...
  const commands: Command[] = [
    ...
    { id: 'nav-inbox', title: 'Go to Inbox', icon: '📥', keywords: ['inbox', 'jarvis', 'messages'], action: () => onNavigate('jarvis-inbox'), category: 'navigation' },
    { id: 'nav-brief', title: 'Go to Daily Brief', icon: '🌅', keywords: ['brief', 'daily', 'summary'], action: () => onNavigate('daily-brief'), category: 'navigation' },
